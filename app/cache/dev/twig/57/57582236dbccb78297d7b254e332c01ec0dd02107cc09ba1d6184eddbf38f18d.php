...
class __TwigTemplate_1185dde2b7c683e9790d65fd41434906fada455f2a7e2ead12967b44a70f2345 extends Twig_Template
{
...
";
    ...
    public function getdisplay_message($__log_index__ = null, $__log__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 93
            echo "    ";
            if ((twig_constant("Symfony\\Component\\HttpKernel\\Debug\\ErrorHandler::TYPE_DEPRECATION") == (($this->getAttribute($this->getAttribute(($context["log"] ?? null), "context", array(), "any", false, true), "type", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["log"] ?? null), "context", array(), "any", false, true), "type", array()), 0)) : (0)))) {
                // line 94
                echo "        DEPRECATION -  ";
...
{% macro display_message(log_index, log) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/var/www/html/ecommerce/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
